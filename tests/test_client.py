...
from openhermes._base_client import (
    DEFAULT_TIMEOUT,
...
class TestOpenhermes:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "openhermes/_legacy_response.py",
                        "openhermes/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "openhermes/_compat.py",
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Openhermes) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.api.conversation.with_streaming_response.list().__enter__()
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/api/conversation").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        ...
        response = client.api.conversation.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.api.conversation.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncOpenhermes:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.api.conversation.with_streaming_response.list().__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.api.conversation.with_raw_response.list()
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.api.conversation.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from openhermes._utils import asyncify
        from openhermes._base_client import get_platform
